...
public class TC_002_SearchLanguages extends BaseClass{
	@Test
	public void courseList()
	{
		logger.info("Strating TC_002_SearchLanguages for language learning");
		...
		fp.selectLanguage();
		logger.info("TestCase:2 executed successfully");
	}
}